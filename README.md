...
are generated by `npm run og` and committed. Project screenshots live in
`src/assets/projects/<slug>.jpg`, generated by `npm run thumbs` and committed; a project
without a site can carry a hand-placed `.jpg` or `.png` under its slug.
