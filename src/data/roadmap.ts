...
export interface Pairing {
  ...
  note: string;        // why this lands here — and ONLY that. The title, the
                       // count (`total`) and the build hint (`pairsWith`)
                       // are the item's own; repeating one here is a second
                       // copy that drifts. Empty is fine and common.
...
export const phases: Phase[] = [
  {
    ...
    fromWeek: 0, toWeek: 0,
    reading: [
      { ref: "aposd.s1", note: "the judgment lens" },
      ddiaCh(1, "the rubric for every later call"),
    ],
    foundations: [
      { ref: "fd.pyci", note: "the refresher" },
      { ref: "fd.dsab", note: "start it" },
      { ref: "fd.nc.arrays", note: "begins here" },
    ],
  },
  {
    ...
    reading: [
      ddiaCh(3, "log-structured hash indexes"),
      { ref: "ostep.p1", note: "alongside RDB/AOF" },
      { ref: "ostep.p2", note: "alongside RDB/AOF" },
      { ref: "ostep.p3", note: "alongside RDB/AOF" },
      { ref: "ostep.p4", note: "alongside RDB/AOF" },
      { ref: "ostep.c1", note: "alongside replication" },
      { ref: "ostep.c2", note: "alongside replication" },
      { ref: "ostep.c3", note: "alongside replication" },
      ddiaCh(5, ""),
      { ref: "aposd.s2", note: "light read" },
    ],
    foundations: [
      { ref: "fd.dsab", note: "finish it" },
      { ref: "fd.coreskills", note: "" },
      { ref: "fd.nc.arrays", note: "" },
      { ref: "fd.nc.twopointers", note: "" },
      { ref: "fd.nc.sliding", note: "" },
      { ref: "fd.nc.stack", note: "" },
      { ref: "fd.nc.linkedlist", note: "" },
    ],
  },
  {
    ...
    reading: [
      ddiaCh(2, ""),
      ddiaCh(3, "deep — B-trees vs LSM-trees"),
      dbintCh(1, "the exact match for this build"),
      dbintCh(2, ""),
      dbintCh(3, ""),
      dbintCh(4, ""),
    ],
    foundations: [
      { ref: "fd.nc.binsearch", note: "" },
      { ref: "fd.nc.trees", note: "" },
      { ref: "fd.nc.tries", note: "" },
    ],
  },
  {
    ...
    reading: [
      ddiaCh(4, "JSON, Protobuf, Avro, schema migrations"),
      dbintCh(5, "trailing read"),
      dbintCh(6, "trailing read"),
      dbintCh(7, "trailing read"),
      { ref: "aposd.s3", note: "light read" },
    ],
    foundations: [
      { ref: "fd.nc.heap", note: "" },
      { ref: "fd.nc.backtracking", note: "" },
    ],
  },
  {
    ...
    reading: [
      ddiaCh(6, "sets up M5"),
      { ref: "aposd.s4", note: "light read" },
    ],
    foundations: [
      { ref: "fd.nc.greedy", note: "" },
      { ref: "fd.nc.intervals", note: "" },
    ],
  },
  {
    ...
    reading: [
      ...
      dbintCh(13, ""),
      dbintCh(14, ""),
      { ref: "aposd.s5", note: "light read — finishes the book" },
    ],
    foundations: [
      { ref: "fd.nc.graphs", note: "" },
      { ref: "fd.nc.advgraphs", note: "" },
      { ref: "fd.nc.dp1", note: "" },
      { ref: "fd.nc.dp2", note: "" },
    ],
  },
  {
    ...
    reading: [
      ddiaCh(10, ""),
      ddiaCh(11, ""),
      ddiaCh(12, "finishes DDIA"),
    ],
    foundations: [
      { ref: "fd.nc.mathgeo", note: "" },
      { ref: "fd.nc.bits", note: "" },
      { ref: "fd.advanced", note: "", optional: true },
    ],
  },
];
