...
// The one testimonial on the site (everything-else spec §6.1). It came out of
// 100Devs, which is no longer on the timeline; the quote stands on its own at
// the hiring moment. Nothing imports it right now — it was pulled out of the
// contact block and kept here for when it goes back in.
